 ...
 * Example 1: 
 * Input: arr = [10,2,5,3] 
 * Output: true Explanation: N = 10 is the
 * double of M = 5,that is, 10 = 2 * 5.
 * 
 * Example 2: 
 * Input: arr = [7,1,14,11] 
 * Output: true Explanation: N = 14 is the
 * double of M = 7,that is, 14 = 2 * 7.
 * 
 * Example 3: Input: arr = [3,1,7,11]
 * Output: false Explanation: In this case
 ...
 * 
 * Hint #1: 
 * Loop from i = 0 to arr.length, maintaining in a hashTable the array
 * elements from [0, i - 1].
 * 
 * Hint #2: 
 * On each step of the loop check if we have seen the element 2 *
