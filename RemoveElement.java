 ...
 * do this by modifying the input array in-place with O(1) extra memory. The order of
 ...
 * returned length. For example if you return 2 with nums = [2,2,3,3] or 
 ...
 * says that the element beyond the new length of the array can be anything. Given
 * an element, we need to remove all the occurrences of it from the array. We don't
